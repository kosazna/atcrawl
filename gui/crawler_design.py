...
class Ui_CrawlerUI(object):
    def setupUi(self, CrawlerUI):
        ...
        self.bt_launch.setGeometry(QtCore.QRect(670, 100, 100, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.check_export.setGeometry(QtCore.QRect(530, 100, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_items.setGeometry(QtCore.QRect(380, 100, 41, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.count_items.setGeometry(QtCore.QRect(430, 100, 61, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(11)
        font.setBold(True)
