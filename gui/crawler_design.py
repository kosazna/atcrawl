...
class Ui_CrawlerUI(object):
    def setupUi(self, CrawlerUI):
        ...
        self.status_browser.setGeometry(QtCore.QRect(70, 50, 71, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_crawler.setGeometry(QtCore.QRect(160, 50, 61, 30))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.output.setGeometry(QtCore.QRect(10, 450, 781, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
