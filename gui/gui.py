...
class CrawlerUI(QWidget):
    ...
    def setupUi(self):
        ...
        self.inputMeta0.setMinimumEditWidth(200)
        self.inputMeta1 = InputParameter('Meta1')
        self.inputMeta1.setMinimumEditWidth(200)
        self.inputMeta2 = InputParameter('Meta2')
        self.inputMeta2.setMinimumEditWidth(200)
        self.inputMeta3 = IntInputParameter('Meta3', value_range=(-99, 99))
        self.inputMeta3.setMinimumEditWidth(200)
        ...
        self.inputFilename.setMinimumEditWidth(200)
