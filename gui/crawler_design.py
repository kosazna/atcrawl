...
"")
        ...
        self.bt_launch.setGeometry(QtCore.QRect(500, 100, 100, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
...
"")
        ...
        self.bt_launch_collect.setGeometry(QtCore.QRect(610, 100, 160, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
...
"")
        ...
        self.check_export.setGeometry(QtCore.QRect(620, 360, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(10)
        font.setBold(True)
